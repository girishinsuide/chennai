  ...
  >
    ...
    >
      <v-sheet
        ...
        height="100%"
      >
        <div class="d-flex fill-height carouselText mt-5">
          <div>
           <h2> {{ slide.title }} </h2>
           <p> {{ slide.detail }} </p>
            <v-card-actions>
...
.carouselText h2 {font-weight: 700;
font-size: 44px;
line-height: 51px;
...
.headingBox-txt h2 {font-style: normal;
font-weight: 700;
font-size: 24px;
line-height: 32px;
letter-spacing: -0.02em;
...
.headingBox-txt p {font-style: normal;
font-weight: 500;
font-size: 18px;
line-height: 28px;
color: #6B7280;}
...
font-size: 18px;
line-height: 28px;
color: #6B7280;float: left;
}

.imageBox-txt .gradient-button {font-weight: 700;
font-size: 16px;
